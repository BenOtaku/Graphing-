...
// end of check user's input.
     ...
     if(dis<0){
// if Discriminant remainder is equal to zero then simplify:
...
//Display results:
        ...
        document.getElementById('x1').innerHTML="Alpha (x') = " + negB + "+" + posDis + "i" + "/" + 2*a;
        document.getElementById('x2').innerHTML="Beta (x'') = "  + negB + "-" + posDis + "i" + "/" + 2*a;
